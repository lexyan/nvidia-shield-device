...
PRODUCT_COPY_FILES += \
    ...
    $(NVFLASH_FILES_PATH)/partition_tables/darcy/flash_t210_intt210b01_darcy_android_sdmmc.xml:flash_t210_intt210b01_darcy_android_sdmmc.xml \
...
PRODUCT_COPY_FILES += \
  ...
  $(LOCAL_PATH)/ueventd.t210ref.rc:root/ueventd.jetson_cv_k49.rc \
  ...
  $(LOCAL_PATH)/fts.ko:system/lib/modules/fts.ko \
  $(LOCAL_PATH)/sensor00fn11.idc:system/usr/idc/sensor00fn11.idc \
  $(LOCAL_PATH)/../../common/nvphsd_setup.sh:system/bin/nvphsd_setup.sh \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/init.jetson_cv.rc:root/init.jetson_cv_k49.rc \
    ...
    $(LOCAL_PATH)/init.recovery.darcy.rc:root/init.recovery.foster_e_hdd.rc \
...
PRODUCT_COPY_FILES += \
    ...
    $(DEVICE_ROOT)/common/adbenable.sh:system/bin/adbenable.sh
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/fstab_m.t210ref:root/fstab.jetson_cv_k49 \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/fstab_m.t210ref_encrypt:root/fstab.jetson_cv_k49
else
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/fstab_m.t210ref:root/fstab.jetson_e \
    $(LOCAL_PATH)/fstab_m.t210ref:root/fstab.jetson_cv \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/fstab.t210ref:root/fstab.jetson_cv_k49 \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/power.abca.rc:system/etc/power.abca.rc \
    $(LOCAL_PATH)/power.abca.rc:system/etc/power.abcb.rc \
    $(LOCAL_PATH)/power.jetson_e.rc:system/etc/power.jetson_cv.rc \
    $(LOCAL_PATH)/power.jetson_e.rc:system/etc/power.jetson_cv_k49.rc \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/thermalhal.jetson_e.xml:system/etc/thermalhal.jetson_cv_k49.xml
...
PRODUCT_COPY_FILES += $(BCMBINARIES_PATH)/bcm4354a1/bluetooth/BCM4354_003.001.012.0163.0000_Nvidia_NV54_TEST_ONLY.hcd:$(TARGET_COPY_OUT_VENDOR)/firmware/bcm4350.hcd
...
ifneq ($(filter foster_e% darcy%,$(TARGET_PRODUCT)),)
